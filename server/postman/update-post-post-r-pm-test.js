...
// Check that the response is an object (updated post)
pm.test("Response is an updated post object", function () {
  pm.expect(responseBodyJson).to.be.an("object");
});

// Check that the post has required properties
pm.test("Updated post has required properties", function () {
